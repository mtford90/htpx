...
Always call `htpx_get_status` first to confirm the daemon is running. If it is not running, tell the user to run `htpx intercept` in their project directory.
